(function () {	
	ex.using([
  	...
  	function () {		
		//--Startup new engine
		var _engine = new ex.Engine(960, 640, 30);
		
		//--Setup rendering
		_engine.setupCanvas("#000000");
		_engine.enableDebugging();
             
        _engine.renderer.canvas.style.position = "absolute";
        _engine.renderer.canvas.style.top = "0px";
        _engine.renderer.canvas.style.left = "0px";
...
//		document.getElementById("buttonJump").addEventListener('mousedown', titleScreenToGame, false);
	...
	function startGame(_engine) {		
		...
		var level1Tiles = [
					...
					[  11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11, 11,  6, 	0, 	0,  0,  0, 83, 83, 83, 83,  0, 10],
